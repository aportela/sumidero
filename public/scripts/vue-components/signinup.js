var signInUp = (function () {
            ...
            <div class="container">
                <div class="columns is-vcentered">
                    <div class="column is-4 is-offset-4">
                        <h1 class="title has-text-centered"><span class="icon is-medium"><i class="fa fa-music rainbow-transition" aria-hidden="true"></i></span> Sumidero <span class="icon is-medium"><i class="fa fa-music rainbow-transition" aria-hidden="true"></i></span></h1>
    ...
    /* signIn component */
    var module = Vue.component('sumidero-signin-component', {
        template: template(),
        created: function () {
        },
        data: function () {
        ...
        methods: {
            submitSignIn: function () {
                ...
                self.loading = true;
                self.errors = false;
                sumideroAPI.signIn(this.signInEmail, this.signInPassword, function (response) {
                    if (response.ok) {
            ...
            submitSignUp: function () {
                ...
                self.loading = true;
                self.errors = false;
                sumideroAPI.signUp(this.signUpEmail, this.signUpPassword, function (response) {
                    if (response.ok) {

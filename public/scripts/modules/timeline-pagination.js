...
export default {
    name: 'sumidero-timeline-pagination',
    template: template(),
    data: function () {
        return ({
    ...
    watch: {
        resultsPage: function (v) {
            ...
            this.$emit("change", { currentPage: 1, resultsPage: this.data.resultsPage });
        }
    },
    methods: {
        navigateToPreviousPage: function () {
            if (this.data.currentPage > 1) {
                ...
                this.$emit("change", { currentPage: this.data.currentPage, resultsPage: this.data.resultsPage });
            }
        },
